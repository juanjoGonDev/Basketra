...
function installCatalogView() {
  ...
  view.innerHTML = `
    ...
    <app-dialog id="catalog-price-dialog" class="confirm-dialog catalog-price-dialog" aria-labelledby="catalog-price-dialog-title"><form id="catalog-price-form" class="dialog-content"><span class="dialog-icon" data-icon="prices"></span><p class="eyebrow">Precio manual</p><h2 id="catalog-price-dialog-title">Añadir precio</h2><p id="catalog-price-dialog-copy">Registra una nueva observación sin sobrescribir el histórico.</p><label class="field"><span>Tienda</span><select id="catalog-price-store" required><option value="">Selecciona una tienda</option></select></label><label class="field"><span>Precio (€)</span><input id="catalog-price-value" inputmode="decimal" autocomplete="off" placeholder="0,00" required></label><p id="catalog-price-store-help" class="field-help"></p><p id="catalog-price-state" class="inline-status" role="alert" aria-live="assertive"></p><div class="dialog-actions"><button id="catalog-price-cancel" class="button secondary" type="button">Cancelar</button><button id="catalog-price-save" class="button primary" type="submit"><span data-icon="check"></span>Guardar precio</button></div></form></app-dialog>
        <app-dialog id="catalog-delete-dialog" class="confirm-dialog" aria-labelledby="catalog-delete-title"><div class="dialog-content"><span class="dialog-icon" data-icon="alert"></span><h2 id="catalog-delete-title">Eliminar producto</h2><p id="catalog-delete-impact">Comprobando dependencias…</p><p class="inline-status" role="status" id="catalog-delete-state"></p><div class="dialog-actions"><button id="catalog-delete-cancel" class="button secondary" type="button">Cancelar</button><button id="catalog-delete-confirm" class="button danger" type="button" disabled>Eliminar producto</button></div></div></app-dialog>`;
  main.append(view);
  hydrateIcons(view);
}
...
function installCategoryView() {
  ...
  view.innerHTML = `
    ...
    <section id="category-detail" class="inventory-detail-screen" aria-labelledby="category-form-title" hidden>
      ...
      <app-dialog id="category-delete-dialog" class="confirm-dialog" aria-labelledby="category-delete-title"><div class="dialog-content"><span class="dialog-icon" data-icon="alert"></span><h2 id="category-delete-title">Eliminar categoría</h2><p id="category-delete-impact">Comprobando productos y subcategorías…</p><p id="category-delete-state" class="inline-status" role="status"></p><div class="dialog-actions"><button id="category-delete-cancel" class="button secondary" type="button">Cancelar</button><button id="category-delete-confirm" class="button danger" type="button" disabled>Eliminar categoría</button></div></div></app-dialog>
    </section>`;
  main.append(view);
  hydrateIcons(view);
}
