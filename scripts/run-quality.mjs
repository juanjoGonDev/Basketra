...
const commands=[
  ...
  ['node',['--experimental-strip-types','--experimental-test-coverage',"--test-coverage-include=src/web/sw.js",'--test-coverage-lines=100','--test-coverage-functions=100','--test-coverage-branches=100','--test','tests/unit/service-worker-shell.test.ts']],
